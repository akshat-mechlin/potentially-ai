  ...
  return (
    ...
    <div className={cn("app-shell min-h-[100dvh] bg-background", immersiveMobile && "app-shell-immersive")}>
      ...
      >
        ...
        <main className={cn("app-main flex-1", immersiveMobile && "app-main-immersive", hideAppHeader && "app-main-fullscreen")}>
          ...
          <MobilePageTransition>
            ...
            <MobileAppChrome immersive={immersiveMobile || hideAppHeader}>
              ...
              <div className={cn("app-page", immersiveMobile || hideAppHeader ? "app-page-immersive" : "space-y-6 sm:space-y-8")}>
